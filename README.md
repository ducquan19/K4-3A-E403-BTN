# K4-3A-E403-BTN
Mini Hackathon - AI In Action Cohort 4
...
**Lớp:** 3A · **Phòng:** ____ · **Cụm:** ____ · **Track:** A1 (VLearn Tutor)

| Họ và Tên | Mã Học Viên | Vai trò chính | Phần việc đảm nhiệm trong dự án |
|---|---|---|---|
| **Chu Phúc Anh** *(Đội trưởng)* | 2A202602370 | **Product & Spec Lead** | Chịu trách nhiệm chính về AI Spec (§1, §2, §4), lát cắt 1 câu, bảng so sánh impact & quy trình nộp bài mốc CP1-CP4 |
| **Trần Đức Quân** | 2A202602922 | **Data Mining & Evidence** | Khai phá chatlog 13.494 lượt, trích xuất số liệu trích dẫn/lỗi, xây dựng Golden Set ≥20 case kiểm thử trong `eval/` |
| **Bùi Minh Quân** | 2A202602958 | **AI & Prompt Engineer** | Thiết kế prompt Grounded Tutor, tích hợp ≥1 lời gọi AI thật, xử lý 4 lớp chỗ khó (chống ảo giác, từ chối ngoài phạm vi) |
| **Đỗ Quang Vinh** | 2A202602989 | **Prototype & Validation** | Dựng giao diện/flow tương tác bấm được (CP2), quay video demo 30s (CP3/CP5), dẫn dắt test với ≥2 willing users ngoài nhóm |

---

## 🎯 CANVAS 4 Ô — CHECKPOINT 1 (Hướng A1: VLearn Grounded Tutor)

| Ô 1: NGƯỜI DÙNG & NỖI ĐAU | Ô 2: BẰNG CHỨNG BAN ĐẦU |
|---|---|
| **Học viên muốn hiểu đúng trọng tâm mà không bị tutor bịa kiến thức**<br><br>• **Job:** Học viên đang tự học/ôn bài trên trang VLearn, bôi đen đoạn tài liệu hoặc gõ hỏi sâu để làm rõ khái niệm.<br>• **Pain:** Khi câu hỏi vượt ngoài slide đang mở hoặc quá mơ hồ, người học bị nhận lại giải thích lan man, phỏng đoán không trích dẫn nguồn; dẫn đến hiểu sai kiến thức và mất niềm tin. | **Mining từ 13.494 lượt chatlog thật**<br><br>• **28%** câu trả lời không có trích dẫn tài liệu (`has_citation = False`, 3.781 lượt).<br>• **90%** phản hồi dập khuôn `review_concept`; tutor chỉ hỏi ngược **28/13.494 lượt (0.2%)**.<br>• **Ví dụ:** `T06164` hỏi *"làm bài lab ở đâu"* → tutor đoán mò; `T02371` bôi đen ngoài slide → tutor vẫn cố giải thích dù không có căn cứ. |
| **Ô 3: LÁT CẮT & AUTOMATION** | **Ô 4: NGƯỜI THỬ & PHÂN CÔNG** |
| **Một câu hỏi mở rộng, một ranh giới rõ ràng**<br>`[GROUNDED]` `[CLARIFY]` `[OUT_OF_BOUNDS]`<br><br>• **Lát cắt MỘT CÂU:** *"Một học viên · hỏi khái niệm ngoài phạm vi tài liệu đang mở · AI nhận diện thiếu căn cứ, từ chối giải thích lan man và chỉ dẫn nguồn chuẩn · học viên không bị tiếp nhận kiến thức sai."*<br>• **Conditional:** Tự trả khi nguồn đủ chắc; hỏi lại khi mơ hồ; từ chối khi ngoài phạm vi. *Cost-of-error: học sai kiến thức domain rất đắt.* | **Có người thử, có người chịu trách nhiệm**<br><br>• **Willing users dự kiến:** Mời test ≥2 học viên ngoài nhóm trong lớp ngay sau khi có bản thử nghiệm.<br>• **4 thành viên chịu trách nhiệm:**<br>  1. Đỗ Quang Vinh: Spec & Product Lead<br>  2. Trần Đức Quân: Data Mining & Golden Set Eval<br>  3. Bùi Minh Quân: Prompt Engineer & AI Model Call<br>  4. Chu Phúc Anh: Prototype Flow & User Validation |
